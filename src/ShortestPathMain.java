...
public class ShortestPathMain {
	...
	public void myGraph(){
		...
		matrix[0][1] = 796;	matrix[0][3] = 666;   
                matrix[1][2] = 902; 
		matrix[1][0] = 796;	matrix[1][2] = 902;	matrix[1][4] = 240;
                matrix[2][1] = 902; matrix[2][7] =434; matrix[3][0] =666; matrix[3][4] = 699; matrix[3][5]=422; 
                matrix[4][1] = 240; matrix[4][3] = 699; matrix[4][6] = 569; matrix[5][3] = 422; matrix[5][6] = 658;
                matrix[5][8] = 347; matrix[6][4] = 569; matrix[6][5] = 658; matrix[6][10] = 128; matrix[7][2] = 434;
                matrix[7][6] = 390; matrix[7][18] = 987; matrix[8][5] =347; matrix[8][9] =544; matrix[8][11] = 278;
                matrix[9][8] = 544; matrix[9][10] =125; matrix[9][12] = 476; 
                matrix[10][6] = 128; matrix[10][9] =125; matrix[11][8] = 278; matrix[11][12]=800; matrix[11][13] = 414;
                matrix[12][9] =476; matrix[12][11] = 100; matrix[12][16] =267; matrix[13][11] = 414; matrix[13][14] = 597;
                matrix[13][19] =557; matrix[14][13] = 597; matrix[14][15] = 324; matrix[14][19] = 757; matrix[15][14]=324;
                matrix[15][16] = 198; matrix[15][22] = 680; matrix[16][12] =267; matrix[16][15] =198; matrix[16][17] = 477;
                matrix[17][16] = 477; matrix[17][18] = 124; matrix[17][20] = 509; matrix[18][7] = 987; matrix[18][17] = 124;
                matrix[18][25]= 1670; matrix[19][13]=557; matrix[19][14]=757; matrix[19][21] =845; matrix[20][17] =509;
                matrix[20][22]=321;     matrix[20][25] = 637; matrix[21][19] = 845; matrix[21][23]=606; matrix[21][24] = 1320; matrix[22][15] =680;
                matrix[22][20] =321; matrix[22][23] = 640; matrix[23][21] = 606; matrix[23][22] = 640; matrix[23][24] =492; matrix[24][21] =1320;
                matrix[24][23] =492; matrix[24][25] = 955; matrix[25][18] =1670; matrix[25][20] = 637; matrix[25][24] = 955;
	...
	public void displayPath(){
		...
		while(i>=0){
            ...
            System.out.println("\nJarak terpendek : "+jarak[indeks-97]+" meter");
	}
